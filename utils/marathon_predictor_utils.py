...
def save_model(model: torch.nn.Module, scaler: StandardScaler, model_path: str, scaler_path: str) -> None:
...
def validate_model_files(model_path: str, scaler_path: str) -> bool:
    ...
    """
    return (
        os.path.exists(model_path) and os.access(model_path, os.R_OK) and
        os.path.exists(scaler_path) and os.access(scaler_path, os.R_OK)
    )