...
class MarathonPredictor:
    ...
    def load_model1(self, model_path: Optional[str] = None, scaler_path: Optional[str] = None) -> None:
    ...
    def load_model2(self, model_path: Optional[str] = None, scaler_path: Optional[str] = None) -> None:
    ...
    def predict_single_race(self, distance: float, time_minutes: float, mileage: float) -> float:
    ...
    def predict_dual_race(
        ...
        return predict_marathon_time_model2(
            self.model2, self.scaler2, distance1, time1_minutes, 
    ...
    def predict_both(
        ...
        if self.model1 is not None and self.scaler1 is not None:
            ...
            results["model1"] = self.predict_single_race(distance2, time2_minutes, mileage)
        ...
        if not results:
            raise RuntimeError("No models loaded. Call load_model1() and/or load_model2() first.")
